        ...
        <div className="mx-auto grid w-full max-w-7xl gap-20 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-5xl font-light tracking-[-0.05em] md:text-7xl">
              {lang === "tr"
                ? "Seçkin Stil Dünyasına Katılın"
                : "Join A Refined Style World"}
            </h1>
            ...
            <p className="mt-8 max-w-xl text-lg leading-9 text-gray-300">
              {lang === "tr"
                ? "Premium koleksiyonlara erişin, favorilerinizi kaydedin ve kişisel alışveriş deneyiminizi oluşturun."
                : "Access premium collections, save your favorites and create your personal shopping experience."}
            </p>
          </div>
          ...
          <div className="lg:flex lg:justify-end">
            ...
            >
              <p className="mb-10 text-sm uppercase tracking-[0.35em] text-[#c8a45d]">
                {lang === "tr" ? "Kayıt Ol" : "Create Account"}
              </p>
              ...
              <p className="mt-8 text-center text-sm text-[#b8b0a1]">
                ...
                <Link href="/login" className="text-[#c8a45d]">
